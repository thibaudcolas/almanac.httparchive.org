...
Surprise for us was jQuery. It wasn’t a surprise that it’s used for Hugo and Jekyll based sites (more than 60%), but that it’s used inside React and Vue based sites!!! Next.js, Nuxt,js, and Gatsby based sites use jQuery too.
